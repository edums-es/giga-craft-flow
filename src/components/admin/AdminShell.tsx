  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      <div className="flex min-h-screen">
        {/* Sidebar */}
        <aside className="hidden w-64 shrink-0 border-r border-border bg-card/95 md:flex md:flex-col">
          <div className="flex items-center gap-3 border-b border-border px-5 py-5">
            ...
            <div className="min-w-0">
              <p className="truncate font-display text-lg leading-none">{brand.nome}</p>
          ...
          <div className="space-y-1 border-t border-border p-3">
            ...
            {email && (
              <p className="mt-2 truncate px-3 text-[10px] text-muted-foreground/70">{email}</p>
            )}
          </div>
        </aside>
        ...
        <main className="min-w-0 flex-1">
          <header className="sticky top-0 z-30 border-b border-border bg-background/85 backdrop-blur">
            <div className="mx-auto flex max-w-[1680px] items-center justify-between gap-4 px-6 py-5">
              <div className="min-w-0">
